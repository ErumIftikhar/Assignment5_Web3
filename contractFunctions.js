...
contractAddress = "0x95f0fB9cB210890EE98FfA2C6716cD75d937C867";
contractAbi = [
{
...
const contractMethodAsync = async() => {
    try { 
		...
		data: contract.methods.store(30).encodeABI(),
		to: contractAddress
        ...
        const signedTransaction = await web3.eth.sendSignedTransaction(txHex);
